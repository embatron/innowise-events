    ...
    $types[] = new ObjectType([
      ...
      'fields' => function () {
        ...
        if ($config->get('settings.svg_image')) {
          ...
          // @see https://www.drupal.org/node/2157945
          // @phpcs:ignore
          /** @disregard P1010 Undefined function */
          $svg_max = DeprecationHelper::backwardsCompatibleCall(
            currentVersion: \Drupal::VERSION,
            deprecatedVersion: '10.2',
            currentCallable: fn() => ByteSizeMarkup::create($svg_max * 1024),
            // @phpstan-ignore-next-line
            deprecatedCallable: fn() => format_size($svg_max * 1024),
          );
